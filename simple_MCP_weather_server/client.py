...
client.py
=========
Aqui criamos um cliente (pode ser Claude Desktop, etc) para interagir com o servidor
meteorológico (weather.py). Em nosso caso, precisamos criar um cliente já que no temos Claude
Desktop para Linux.

Link de estudo ---> https://modelcontextprotocol.io/quickstart/client

Run
===

uv run client.py /home/karinag/1_GitHub/Foundations_of_Model_Context_Protocol_MCP/simple_MCP_weather_server/weather.py
"""
import asyncio
...
class MCPClient:
    ...
    async def chat_loop(self):
        ...
        print("\n🤗 MCP Client Iniciado 🤗!")
        print("Apenas consultas do clima para USA")
